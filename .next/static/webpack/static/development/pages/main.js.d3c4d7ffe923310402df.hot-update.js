...
var Main = function Main(_ref) {
  ...
  var createOrder = function createOrder() {
    _api_order__WEBPACK_IMPORTED_MODULE_12__["OrderAPI"].createOrder(materialsState[0].id).then(function (response) {// console.log(response.data)
    })["catch"](function (err) {
  ...
  }, "Buy course ($", materialsState && ((_materialsState$2 = materialsState[0]) === null || _materialsState$2 === void 0 ? void 0 : _materialsState$2.price), ".00)"), error ? __jsx("div", {
  ...
  }, error)) : null, __jsx(next_link__WEBPACK_IMPORTED_MODULE_9___default.a, {
    href: lessonsURL,
    __self: _this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=main.js.d3c4d7ffe923310402df.hot-update.js.map