...
var Authorization = function Authorization(_ref) {
  ...
  var authorize = function authorize(e) {
    e.preventDefault();
    _api_auth__WEBPACK_IMPORTED_MODULE_4__["AuthAPI"].auth(login.value.replace(/[\s\-\_\(\)]+/g, ''), password.value).then(function (response) {
...
//# sourceMappingURL=authorization.js.68dd8b57d9a9e61e14e1.hot-update.js.map